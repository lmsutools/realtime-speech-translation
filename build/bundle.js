...
__webpack_require__.d(__webpack_exports__, {
  buildHTMLTranscript: () => (/* binding */ buildHTMLTranscript),
  buildParagraphsFromWords: () => (/* binding */ buildParagraphsFromWords),
  buildPlainTranscript: () => (/* binding */ buildPlainTranscript),
  convertParagraphsToText: () => (/* binding */ convertParagraphsToText),
  convertTextToParagraphs: () => (/* binding */ convertTextToParagraphs),
  countSentenceEnders: () => (/* binding */ countSentenceEnders),
  createParagraph: () => (/* binding */ createParagraph),
  getSpeakerColor: () => (/* binding */ getSpeakerColor),
  makeWordKey: () => (/* binding */ makeWordKey),
  syncEphemeralWords: () => (/* binding */ syncEphemeralWords)
});

;// ./modules/recording/constants.js
...
;// ./modules/recording/paragraphBuilder.js
 ...
 */
async function validateTranslationConfig() {
    try {
 ...
 */
async function translateWithAI(text, context = '', previousTranslations = '') {
...
const { makeAutoObservable, runInAction } = __webpack_require__(813);
...
// EXTERNAL MODULE: ./stores/appState.js
var appState = __webpack_require__(246);
...
;// ./modules/recording/recordingState.js
class RecordingState {
    ...
    preserveCurrentContent() {
        const { appState } = __webpack_require__(246);
        const { buildHTMLTranscript } = __webpack_require__(143);
...
const recordingState_recordingState = new RecordingState();

// EXTERNAL MODULE: ./modules/recording/paragraphBuilder.js + 1 modules
var paragraphBuilder = __webpack_require__(143);
;// ./modules/recording/uiUpdater.js
class uiUpdater_UIUpdater {
...
;// ./modules/recording/translationHandler.js
...
var mobx_esm = __webpack_require__(813);
;// ./modules/recording/index.js
...
async function startRecording(isRestart = false) {
    ...
    try {
        ...
        recordingState_recordingState.socket.onopen = async () => {
            ...
            if (isRestart && recordingState_recordingState.preservedContent) {
                ...
                recordingState_recordingState.preservedContent = "";
                recordingState_recordingState.finalTranscription = "";
                recordingState_recordingState.finalParagraphs = [];
                recordingState_recordingState.translationParagraphs = [];
                recordingState_recordingState.ephemeralWords.clear();
...
window.appState = appState.appState;
