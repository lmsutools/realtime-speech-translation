...
ipcMain.on('translation-setting-changed', (event, enableTranslation) => {
    ...
    if (mainWindow && !mainWindow.isDestroyed()) { mainWindow.webContents.send('update-translation-ui', enableTranslation); }
...
ipcMain.on('unregister-global-shortcut', () => { globalShortcut.unregisterAll(); });
    ...
    if (store) {
        ...
        runInAction(() => {
            switch (key) {
                ...
                case 'deepgramApiKey': appState.setDeepgramApiKey(value);
